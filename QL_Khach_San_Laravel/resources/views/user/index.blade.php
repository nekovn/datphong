    ...
    <div class="main-container">
                    ...
                    <div class="align-bottom">
                        ...
                        <div class="row">
                            <div class="col-md-3 col-sm-6 col-xs-12 text-center-xs mb-xs-24">
                                <h4 class="uppercase mb0 bold">PhamTuanHotel</h4>
        ...
        <section>
            ...
            <div class="container">
                <div class="row v-align-children">
                    <div class="col-sm-5">
                        <h3>Book a Room at PhamTuanHotel</h3>
                    ...
                    <div class="col-sm-6 col-md-6">
                        <div class="pricing-table pt-1 text-center emphasis">
                            ...
                            <p>
                                ...
                                <br> large group bookings&nbsp;<br>0921 277 127<br><br><br>
                            </p>
                        </div>
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-md-5 col-md-offset-1 col-sm-6 mb40 mb-xs-24">
                        ...
                        <p style="color: #fff">PhamTuanHotel opened 2012 as a family-run value mini-hotel. The
                            ...
                            concept of PhamTuanHotel is "no frills, but clean and relaxed".</p>
                    </div>
                    <div class="col-md-5 col-sm-6 mb40 mb-xs-24">
                        ...
                        <p style="color: #fff">At PhamTuanHotel we want to provide a good service at a fair price for
                        ...
                        <div class="row text-center">
                            <div class="col-md-10 col-md-offset-1">
                                ...
                                <p class="lead mb40">The Roof Terrace on the sixth floor is the place to relax, have a
                                    ...
                                    time.</p>
                                <a class="btn btn-lg" href="{{ route('orders') }}" target="_blank">CALL 0921 277
                                    127</a>
                                <a class="btn btn-lg btn-filled" href="{{ route('orders') }}" target="_blank">Book a
                                    ROOM</a>
                            </div>
                    ...
                    <div class="container v-align-transform">
                        <div class="row text-center">
                            <div class="col-md-10 col-md-offset-1">
                                ...
                                <a class="btn btn-lg btn-filled" href="{{ route('orders') }}" target="_blank">Call 0921
                                    277 127</a>
        ...
        <section>
            <div class="container">
                <div class="row">
                    <div class="col-sm-12 text-center">
                        <h4 class="uppercase mb16">PhamTuanHotel Gallery</h4>
                        <p class="lead mb64">
                            Impressions</p>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-sm-12 text-center">
                        ...
                        <p class="lead mb40 mb-xs-24">
                            ...
                            mini hotel.&nbsp;<br>Our address is:&nbsp;<br><br>PhamTuanHotel Cantho&nbsp;<br>93 Mau Than
                            Street&nbsp;<br>Xuan Khanh, Ninh Kieu&nbsp;<br>92000 Can Tho
                            City&nbsp;<br>Vietnam&nbsp;<br>Email:phamquoctuanezg@gmail.com&nbsp;<br>CALL 0921 277
                            127<br></p>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-offset-2 col-sm-12 col-md-9">
                        <h4 class="uppercase mb80">How To Get To PhamTuanHotel</h4>
                                ...
                                <li class="active">
                                    ...
                                    <div class="tab-content">
                                        <p>Go to Le Hong Phong Street in the center of Ho Chi Minh City. There are
                                            ...
                                            in another area or drives around the city. The address: PhamTuanHotel, 132
                                ...
                                <li>
                                    ...
                                    <div class="tab-content">
                                        <p>Many bus companies operate in the Mekong Delta. The major bus companies will
                                            ...
                                            will take care to put you off at the hotel: PhamTuanHotel, 132 Metro, An
                                ...
                                <li>
                                    ...
                                    <div class="tab-content">
                                        <p>
                                            ...
                                            hotel:&nbsp;PhamTuanHotel,&nbsp;132 Metro, An Khanh Ninh Kieu,&nbsp;0921 277
        ...
        <footer class="footer-1 bg-secondary">
            <div class="container">
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <span class="sub" style="color: #fff">PhamTuanHotel Cantho |&nbsp;132 Metro, An Khanh Ninh Kieu,
                            92000 Can Tho City, Vietnam<br>Web PhamTuanHotel.com &nbsp;| Email <a
